...
class BlockPublisher(BlockPublisherInterface):
    ...
    def initialize_block(self, block_header):
        ...
        self._min_wait_time = settings_view.get_setting("dgt.consensus.min_wait_time", self._min_wait_time, float)
        self._max_wait_time = settings_view.get_setting("dgt.consensus.max_wait_time", self._max_wait_time, float)
        self._valid_block_publishers = settings_view.get_setting("dgt.consensus.valid_block_publishers",self._valid_block_publishers,list)
